...
public enum Units
{
    ...
    CHAR_Bandit_StoneBreaker_VBlood_GateBoss_Minor = -1420322422,
    ...
    CHAR_Blackfang_Alchemist = 326501064,
    CHAR_Blackfang_Alchemist_Servant = 2142021685,
    CHAR_Blackfang_CarverBoss_VBlood = -1669199769,
    CHAR_Blackfang_DartFlinger = 1209580976,
    CHAR_Blackfang_DartFlinger_Servant = -253226787,
    CHAR_Blackfang_Livith_Illusion = 1254601307,
    CHAR_Blackfang_Livith_VBlood = -1383529374,
    CHAR_Blackfang_Lucie_VBlood = 1295855316,
    CHAR_Blackfang_Lurker = -1733829912,
    CHAR_Blackfang_Lurker_Servant = 40217214,
    CHAR_Blackfang_Morgana_VBlood = 591725925,
    CHAR_Blackfang_MorganasTail = -1075824048,
    CHAR_Blackfang_Peon = -1562098554,
    CHAR_Blackfang_Peon_Miner = -699233841,
    CHAR_Blackfang_Peon_Servant = -39008356,
    CHAR_Blackfang_PeonCarryingBarrel = 1924724671,
    CHAR_Blackfang_PeonLogCarryer = 1451256919,
    CHAR_Blackfang_Sentinel = 1531777139,
    CHAR_Blackfang_Sentinel_Servant = -1287013240,
    CHAR_Blackfang_Striker = 761646020,
    CHAR_Blackfang_Striker_Servant = -274383877,
    CHAR_Blackfang_Valyr_VBlood = 173259239,
    CHAR_Blackfang_ValyrCauldron = 1439742793,
    CHAR_Blackfang_Venomblade = 1864177126,
    CHAR_Blackfang_Venomblade_Servant = 1906807803,
    CHAR_Blackfang_Viper = -436956599,
    CHAR_Blackfang_Viper_Servant = -1108748448,
    CHAR_Blackfang_WoodCarver = -1508046438,
    CHAR_Blackfang_WoodCarver_Servant = -2089362645,
    CHAR_Blackfang_WoodCarver_Worshipper = -625375348,
    CHAR_BloodBuff_Corrupted_Angel = -932793458, // seems more spell than a char
    CHAR_BloodBuff_Corrupted_Harpy = -143994147, // seems more spell than a char
    CHAR_Carriage_BanditAnimal = 1900336326,
    CHAR_Carriage_BanditCopper = 1866779672,
    CHAR_Carriage_BanditPlank = -364183632,
    CHAR_Carriage_BanditPrisoners = -1190354298,
    CHAR_Carriage_BanditSulfur = 855721879,
    CHAR_Carriage_BlackfangBastion = -1395711815,
    CHAR_Carriage_BlackfangSouth = -2075236675,
    CHAR_Carriage_ChuchGrape = -84975023,
    CHAR_Carriage_ChuchSilver = -1048977650,
    CHAR_Carriage_ChurchLegion = 177376927,
    CHAR_Carriage_ChurchMutants = 400170781,
    CHAR_Carriage_MilitiaCotton = 213173421,
    CHAR_Carriage_MilitiaIron = 769065062,
    CHAR_Carriage_MilitiaQuartz = -75106506,
    CHAR_CarriageHorse_BanditAnimal = -799718518,
    CHAR_CarriageHorse_BanditCopper = -443327719,
    CHAR_CarriageHorse_BanditPlank = -1859852856,
    CHAR_CarriageHorse_BanditPrisoners = -1761137820,
    CHAR_CarriageHorse_BanditSulfur = -1193126567,
    CHAR_CarriageHorse_BlackfangBastion = 731857280,
    CHAR_CarriageHorse_BlackfangSouth = 96544496,
    CHAR_CarriageHorse_ChuchGrape = 803219139,
    CHAR_CarriageHorse_ChuchSilver = -1588337666,
    CHAR_CarriageHorse_ChurchLegion = 452018442,
    CHAR_CarriageHorse_ChurchMutants = -1666526529,
    CHAR_CarriageHorse_MilitiaCotton = -755774482,
    CHAR_CarriageHorse_MilitiaIron = 1510247015,
    CHAR_CarriageHorse_MilitiaQuartz = 374565592,
    ...
    CHAR_Corrupted_Bear_Standard = -1697944553,
    CHAR_Corrupted_Crow = 1029047051,
    CHAR_Corrupted_Deer = 1780171587,
    CHAR_Corrupted_Wolf = 616274140,
    ...
    CHAR_Cursed_Witch_NetherDemon = -54072010,
    ...
    CHAR_Dracula_SpellStone_LargeBlood = 32692466,
    CHAR_EmeryElemental = -1388651766,
    CHAR_EmeryGolem = 1787640747,
    ...
    CHAR_Frostarrow_GateBoss_Minor = 1318855899,
    CHAR_GateBoss_Pixie = -1084690188,
    CHAR_Geomancer_Golem_Minion = -2092246077,
    ...
    CHAR_Gloomrot_Purifier_VBlood_GateBoss_Major = -440174408,
    ...
    CHAR_Harpy_Sorceress_NetherDemon = 1405099312,
    ...
    CHAR_Legion_BloodProphet = 1912966420,
    CHAR_Legion_BloodProphet_Lesser = -2080231735,
    CHAR_Legion_Dreadhorn = 981369753,
    CHAR_Legion_DreadHorn_Lesser = -1140588645,
    CHAR_Legion_Gargoyle = -65981941,
    CHAR_Legion_Gargoyle_StatueSpawn = 280858720,
    CHAR_Legion_Gargoyle_Styx = -392776091,
    CHAR_Legion_Guardian_DraculaMinion = -669027288,
    CHAR_Legion_Guardian_DraculaMinion_Lesser = 1144208724,
    CHAR_Legion_HighLord_GroundSword = -1266036232,
    CHAR_Legion_NightMaiden = -494298686,
    CHAR_Legion_NightMaiden_Lesser = 2111003460,
    CHAR_Legion_NightMaiden_Lesser_Servant = -1099047820,
    CHAR_Legion_NightMaiden_Servant = -340923989,
    CHAR_Legion_Nightmare = -1009917656,
    CHAR_Legion_Nightmare_Lesser = -981051151,
    CHAR_Legion_Shadowkin = 1980594081,
    ...
    CHAR_Mantrap_Corrupted = 1527640414,
    CHAR_Mantrap_Corrupted_Minion = 1906792990,
    CHAR_Mantrap_Corrupted_XL = -1915060856,
    ...
    CHAR_Militia_Fabian_VBlood = 619948378,
    CHAR_Militia_FabiansSteed = 826666431,
    CHAR_Militia_FabiansSteed_Minion = -1509286426,
    ...
    CHAR_Militia_Guard_VBlood_GateBoss_Minor = 1494126678,
    CHAR_Militia_Heavy = 2005508157,
    CHAR_Militia_Heavy_Servant = -1773935659,
    CHAR_Militia_Horseman = -235172198,
    CHAR_Militia_Horseman_Mount = -1914181232,
    CHAR_Militia_Horseman_Summon = -1799461404,
    ...
    CHAR_Militia_Leader_VBlood_GateBoss_Major = 1990744594,
    ...
    CHAR_Militia_Rider = -1719333743, // unmounted crossbowman
    CHAR_Militia_Rider_Mount = -138006205, // Don't summon, causes crash
    ...
    CHAR_Mutant_FleshGolem_PrisonVariant = -1025552087,
    ...
    CHAR_Poloma_VBlood_GateBoss_Minor = -1381375644,
    CHAR_RatHorror_Mutant_MutantBlood = 218843465,
    ...
    CHAR_Spider_Melee_GateBoss_Summon = -725251219,
    CHAR_Spider_Melee_Summon = 2119230788,
    CHAR_Spider_Queen_VBlood = -548489519,
    CHAR_Spider_Queen_VBlood_GateBoss_Major = -943858353,
    ...
    CHAR_Treant_Corrupted = 1496810447,
    CHAR_Treant_NetherDemon = -2037006512,
    CHAR_TreantMantrap_Corrupted_Minion_Left = 358623979,
    CHAR_TreantMantrap_Corrupted_Minion_Right = 2107764370,
    CHAR_Undead_ArenaChampion_VBlood = -753453016,
    ...
    CHAR_Undead_GhostBanshee_MorganaMinion = 153561250,
    ...
    CHAR_Undead_Infiltrator_VBlood_GateBoss_Major = -982850914,
    CHAR_Undead_Leader_Vblood = -1365931036,
    CHAR_Undead_Leader_Vblood_GateBoss_Minor = -989493184,
    ...
    CHAR_Undead_ShadowSoldier_GateBoss = -361904832,
    ...
    CHAR_Undead_SkeletonGolem_NetherDemon = -1115032717,
    ...
    CHAR_Undead_ZealousCultist_VBlood_GateBoss_Major = -1189707552,
    ...
    CHAR_Vampire_Cultist_Channeling_Female = 57255106,
    CHAR_Vampire_Cultist_Female_Servant = 1703325932,
    CHAR_Vampire_Cultist_Male_Servant = 1193263017,
    CHAR_Vampire_Cultist_Patrolling = 2018586909,
    CHAR_Vampire_Cultist_Patrolling_Female = -1610391169,
    CHAR_Vampire_Cultist_PrayingArmsOut = -1438710930,
    CHAR_Vampire_Cultist_PrayingArmsOut_Female = -1074322242,
    CHAR_Vampire_Cultist_PrayingGround = -1832935107,
    ...
    CHAR_Villager_CursedWanderer_VBlood_GateBoss_Major = -1160778038,
    CHAR_Villager_Tailor_VBlood = -1942352521,
    CHAR_Wendigo_GateBoss_Major = 468179469,
    CHAR_Wendigo_VBlood = 24378719,
    CHAR_WerewolfChieftain_Human = -1505705712,
    CHAR_WerewolfChieftain_ShadowClone = -1699898875,
    CHAR_WerewolfChieftain_VBlood_GateBoss_Major = 2079933370,
    CHAR_Winter_Bear_Standard = 2041915372,
    CHAR_Winter_Moose = -779632831,
    CHAR_Winter_Wolf = 134039094,
    CHAR_Winter_Wolf_Dracula_Minion = 2145471156,
    CHAR_Winter_Wolf_WerewolfChief_Minion = -223185284,
    CHAR_Winter_Yeti_VBlood = -1347412392,
    CHAR_Winter_Yeti_VBlood_GateBoss_Major = 666177656,
};