...
public static class WantedConfig
{
    ...
    public static void Initialize()
    {
        ...
        var disableBloodConsumeEntry = _configFile
            .Bind(
                "Wanted",
                "Disable Blood Consume On Spawn",
                false,
                "When enabled, ambush squads spawn without blood consume or feed components so they cannot be fed upon.");
        WantedSystem.DisableBloodConsume = disableBloodConsumeEntry.Value;
        disableBloodConsumeEntry.SettingChanged += (_, _) =>
        {
            WantedSystem.DisableBloodConsume = disableBloodConsumeEntry.Value;
        };
